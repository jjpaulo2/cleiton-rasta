...
PORTAINER_ENDPOINT_ID = int(getenv("PORTAINER_ENDPOINT_ID", "0"))
PORTAINER_CONTAINER_OCI = getenv("PORTAINER_CONTAINER_OCI", "")
PORTAINER_NODE_GAMES = getenv("PORTAINER_NODE_GAMES", "")
